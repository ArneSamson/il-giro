...
export default function NewMaterial({
  ...
  const setTextureIsLoading = useUIStore((state) => state.setTextureIsLoading);
  ...
  const [albedoTexture, normalTexture, roughnessTexture, metallnessTexture] =
    useTexture(
      ...
      (textures) => {
        ...
        const normalTexture = textures[1];
        const roughnessTexture = textures[2];
        const metallnessTexture = textures[3];
