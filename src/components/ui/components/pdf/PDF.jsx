...
Font.register({
  family: "Kaisei Decol",
  src: "/fonts/KaiseiDecol-Regular.ttf",
});
...
export function MyDocument({ props }) {
  ...
  const extraOptions = [
    {
      name: "tower appliance",
      value: props.applianceType ? props.applianceType : "/",
    },
    {
      name: "winestand",
      value: props.wineStandSize ? props.wineStandSize : "/",
    },
      ...
      <Page size='A4' style={styles.page} wrap={true}>
        ...
        <View style={styles.heading}>
          ...
          <View style={styles.orderTitle}>
            <Text>Order #{customerOptions["order number"]}</Text>
          </View>
        </View>

        <View style={styles.orderInfo}>
          <View>
            <Text style={styles.configurationChoiceValueName}>
              {customerOptions["order date"]} {customerOptions["order time"]}
            </Text>
          </View>
          <View style={styles.customerInfo}>
            ...
            <View>
              <Text style={{ ...styles.customerInfoTitle, marginTop: -15 }}>
                Your information:
              </Text>
              <View style={styles.customerInfoValues}>
        ...
        <View style={styles.configurationInfo}>
          <Text style={styles.customerInfoTitle}>Your configuration:</Text>

          <View style={styles.configurationChoices}>
            <View style={styles.configurationChoice}>
              ...
              <View style={styles.materialChoiceValues}>
                ...
                <View>
                  <Text style={styles.configurationChoiceValueName}>
                    {materialOptions.module.name}
                  </Text>
                  <Text style={styles.configurationChoiceValueValue}>
                    {materialOptions.module.value}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.materialChoiceValues}>
                ...
                <View>
                  <Text style={styles.configurationChoiceValueName}>
                    {materialOptions.countertop.name}
                  </Text>
                  <Text style={styles.configurationChoiceValueValue}>
                    {materialOptions.countertop.value}
                  </Text>
                </View>
              </View>
              ...
              {props.accentMaterial && (
                <View style={styles.materialChoiceValues}>
                  ...
                  <View>
                    <Text style={styles.configurationChoiceValueName}>
                      {materialOptions.accent.name}
                    </Text>
                    <Text style={styles.configurationChoiceValueValue}>
                      {materialOptions.accent.value}
                    </Text>
                  </View>
                </View>
              )}
            ...
            <View style={styles.configurationChoice}>
              <Text style={styles.configurationChoiceTitle}>Modules</Text>
              {moduleOptions.map((option, index) => (
                <View key={index} style={styles.configurationChoiceValues}>
                  <Text key={index} style={styles.configurationChoiceValueName}>
                    {option.name}
                  </Text>
                  <Text
                    key={index}
            ...
            <View style={styles.configurationChoice}>
              <Text style={styles.configurationChoiceTitle}>Countertop</Text>
            ...
            <View style={styles.configurationChoice}>
              <Text style={styles.configurationChoiceTitle}>Extras</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Il Giro 2024</Text>
          <Text style={styles.footerText}>info@studiorombauts.be</Text>
          <Text style={styles.footerText}>+32 497 35 48 39</Text>
        </View>
      </Page>
    </Document>
  );
